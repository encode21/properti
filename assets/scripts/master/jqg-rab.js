var RabAdvanced = function () {

    var initTableRab = function() {
		...
		$("#jqRab").jqGrid({
			url: 'index.php/jsmaster/rab/rAllGRab.html',
			datatype: "json",
			editurl: 'index.php/jsmaster/rab/xRab.html',
			colModel: [
				{
					label: "Aksi",
					name: "actions",
				...
				{ label: 'Kode', name: 'kode', key: true, width: 50,editable: true	},
				{ label: 'Nama Group Aktivitas', name: 'nama', width: 300,editable: true,editrules : { required: true} },
				{ label: 'ID', name: 'id', key: true, width: 30,hidden: true },
				{ label: 'Keterangan', name: 'ket', width: 600,editable: true,editrules : { required: true} }
			],
		...
		$(window).bind('resize', function() {
			$("#jqRab").setGridWidth($('.portlet-body').width());
		}).trigger('resize');

		jQuery("#jqRab").jqGrid('setFrozenColumns');
		//jQuery("#jqProyek").jqGrid('inlineNav',"#jqProyek");
		jQuery("#jqRab").jqGrid('navGrid',"#jqRabPager",
		...
		$("#jqRabDet").jqGrid({
			url: 'index.php/jsmaster/rab/rtRab.html',
			datatype: "json",
			editurl: 'index.php/jsmaster/rab/xtRab.html',
			colModel: [
				{
					label: "Aksi",
					name: "actions",
				...
				{ label: 'Group', name: 'klp', key: true, width: 150,hidden: true,frozen: true },
				{ label: 'Kode', name: 'nom', key: true, width: 50,frozen: true,
					editable: true,
					edittype: "select",
					editoptions: {
						dataUrl: "index.php/jsmaster/rab/RabGrJdl.html"
					}
				},
				{ label: 'Nama Pekerjaan', name: 'nama', width: 300,editable: true,editrules : { required: true} },
				{ label: 'ID', name: 'id', key: true, width: 30,hidden: true },
				{ label: 'Divisi', name: 'div', key: true, width: 50,frozen: true,
					editable: true,
					edittype: "select",
					editoptions: {
						//dataUrl: "index.php/jsmaster/rab/RabGrJdl.html"
						value: "1:Marketing;2:Planning"
					}
				},
				{ label: '', name: 'grup', width: 50,hidden: true },
				{ label: 'Default', name: 'def', width: 50,formatter: 'checkbox',editable: true,
					edittype: "checkbox"
				},
				{ label: 'Keterangan', name: 'ket', width: 600,editable: true,editrules : { required: true} }
			],
		...
		$(window).bind('resize', function() {
			$("#jqRabDet").setGridWidth($('.portlet-body').width());
		}).trigger('resize');

		jQuery("#jqRabDet").jqGrid('setFrozenColumns');
		//jQuery("#jqProyek").jqGrid('inlineNav',"#jqProyek");
		jQuery("#jqRabDet").jqGrid('navGrid',"#jqRabDetPager",
			{ edit: false, add: true, del: false}
			//*
			,{ width: 400, recreateForm: true },
			{ width: 400,closeAfterAdd: true, recreateForm: true,
